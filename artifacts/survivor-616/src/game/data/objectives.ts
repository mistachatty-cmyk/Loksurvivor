...
export const OBJECTIVES: ObjectiveDef[] = [
  ...
  { id: 'spiral-hunt', label: 'Down 10 Spiral Moths', kind: 'kill-enemy', enemyId: 'spiral-moth', targetCount: 10, rewardCred: 65, rewardTokens: 0 },
  { id: 'current-hunt', label: 'Down 8 Current Stags', kind: 'kill-enemy', enemyId: 'current-stag', targetCount: 8, rewardCred: 70, rewardTokens: 0 },
  { id: 'ring-hunt', label: 'Down 8 Ring Scribes', kind: 'kill-enemy', enemyId: 'ring-scribe', targetCount: 8, rewardCred: 70, rewardTokens: 0 },
