...
export const CHARACTERS: CharacterDef[] = [
  ...
  },
  {
    ...
    weapon: { id: 'horse-you', name: 'The Horse You', kind: 'punch', description: 'A gigantic off-screen punch lands with comic-book force.', damage: 62, cooldownMs: 1900, range: 135, levelDamageScale: 0.34, impactIntensity: 5, color: '#f472b6' },
  ...
  },
  {
    ...
    weapon: { id: 'orbit-whale', name: 'Orbit Whale', kind: 'wave', description: 'A deep blue breach rolls outward like a whale through stars.', damage: 30, cooldownMs: 1550, range: 190, count: 2, levelDamageScale: 0.27, impactIntensity: 4, color: '#60a5fa' },
  ...
  },
  {
    ...
    weapon: { id: 'punchline', name: 'Punchline', kind: 'punch', description: 'A delayed joke detonates after the first hit lands.', damage: 42, cooldownMs: 2100, range: 150, durationMs: 500, levelDamageScale: 0.32, impactIntensity: 4, color: '#facc15' },
