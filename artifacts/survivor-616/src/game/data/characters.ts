...
export const CHARACTERS: CharacterDef[] = [
  ...
  },
  {
    ...
    weapon: { id: 'triangle-liturgy', name: 'Triangle Liturgy', kind: 'wave', description: 'Three staged wedges fade through the crowd in sequence.', damage: 17, cooldownMs: 1200, range: 170, count: 3, levelDamageScale: 0.25, color: '#fef08a', statusEffectId: 'slow' },
  ...
  },
  {
    ...
    weapon: { id: 'mile-marker', name: 'Mile Marker', kind: 'laser', description: 'A ruler-straight road laser pins a lane from curb to curb.', damage: 27, cooldownMs: 1450, range: 420, levelDamageScale: 0.28, color: '#38bdf8', obstacleInteraction: 'block' },
  ...
  },
  {
    ...
    weapon: { id: 'emberback', name: 'Emberback', kind: 'hazard', description: 'Drops a persistent ring of fire.', damage: 10, cooldownMs: 2100, range: 92, durationMs: 5200, levelDamageScale: 0.22, color: '#ff5f36', statusEffectId: 'burning' },
  ...
  },
  {
    ...
    weapon: { id: 'horse-you', name: 'The Horse You', kind: 'punch', description: 'A gigantic off-screen punch lands with comic-book force.', damage: 62, cooldownMs: 1900, range: 135, levelDamageScale: 0.34, color: '#f472b6' },
  ...
  },
  {
    ...
    weapon: { id: 'glass-eel', name: 'Glass Eel', kind: 'teleport', description: 'Blink-strikes to a threat, then leaves a freezing wake.', damage: 34, cooldownMs: 1700, range: 280, durationMs: 900, levelDamageScale: 0.3, color: '#67e8f9', statusEffectId: 'freeze' },
  ...
  },
  {
    ...
    weapon: { id: 'acid-garden', name: 'Acid Garden', kind: 'hazard', description: 'Plants a corrosive puddle.', damage: 8, cooldownMs: 1800, range: 105, durationMs: 6200, levelDamageScale: 0.2, color: '#b8ff5c', statusEffectId: 'acid' },
  ...
  },
  {
    ...
    weapon: { id: 'allymaker', name: 'Allymaker', kind: 'convert', description: 'Turns the weakest nearby enemy against the horde for a heartbeat.', damage: 16, cooldownMs: 2600, range: 230, durationMs: 5000, levelDamageScale: 0.24, color: '#f9a8d4', statusEffectId: 'slow' },
  ...
  },
  {
    ...
    weapon: { id: 'orbit-whale', name: 'Orbit Whale', kind: 'wave', description: 'A deep blue breach rolls outward like a whale through stars.', damage: 30, cooldownMs: 1550, range: 190, count: 2, levelDamageScale: 0.27, color: '#60a5fa' },
  ...
  },
  {
    ...
    weapon: { id: 'blink-choir', name: 'Blink Choir', kind: 'teleport', description: 'The choir disappears and reappears behind the nearest threat.', damage: 22, cooldownMs: 1250, range: 320, durationMs: 700, levelDamageScale: 0.26, color: '#f0abfc', statusEffectId: 'slow' },
  ...
  },
  {
    ...
    weapon: { id: 'punchline', name: 'Punchline', kind: 'punch', description: 'A delayed joke detonates after the first hit lands.', damage: 42, cooldownMs: 2100, range: 150, durationMs: 500, levelDamageScale: 0.32, color: '#facc15' },
