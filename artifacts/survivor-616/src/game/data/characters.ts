...
export const CHARACTERS: CharacterDef[] = [
  ...
  },
  {
    ...
    stats: { ...BASE_STATS_DEFAULTS, maxHp: 160, speed: 84, power: 1.25, area: 1.2, magnet: 48, armor: 0.16 },
    weapon: {
      id: 'ledger-pulse',
      name: 'Ledger Pulse',
      kind: 'nova',
  ...
  },
  {
    ...
    stats: { ...BASE_STATS_DEFAULTS, maxHp: 195, speed: 72, power: 1.05, area: 1.35, magnet: 38, armor: 0.32 },
    weapon: {
      id: 'house-rules',
      name: 'House Rules',
      kind: 'aura',
  ...
  },
  {
    ...
    stats: { ...BASE_STATS_DEFAULTS, maxHp: 68, speed: 128, power: 0.9, area: 0.85, haste: 0.8, magnet: 44, armor: 0 },
    weapon: {
      id: 'wingflutter',
      name: 'Wingflutter',
      kind: 'melee',
  ...
  },
  {
    ...
    stats: { ...BASE_STATS_DEFAULTS, maxHp: 118, speed: 86, power: 1.1, area: 1.1, magnet: 60, armor: 0.1 },
    weapon: {
      id: 'reaching-current',
  ...
  },
  {
    ...
    stats: { ...BASE_STATS_DEFAULTS, maxHp: 145, speed: 80, power: 1.3, area: 1.4, haste: 1.1, magnet: 50, armor: 0.15 },
    weapon: {
      id: 'sub-drop',
      name: 'Sub Drop',
      kind: 'nova',
