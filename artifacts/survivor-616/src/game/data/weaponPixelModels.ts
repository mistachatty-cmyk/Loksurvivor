...
const KIND_PIXELS: Record<WeaponKind, ReadonlyArray<readonly [number, number, 0 | 1 | 2]>> = {
  ...
  meteor: [[4,3,2],[5,4,2],[6,5,1],[7,6,1],[8,7,1],[9,8,0],[10,9,0],[11,10,0],[12,11,0],[13,12,0],[3,4,1],[3,2,1],[5,2,0],[2,3,0],[6,2,0],[2,5,0],[2,2,0]],
  glitch: [[3,2,2],[3,3,2],[3,4,2],[3,5,2],[3,6,2],[3,7,2],[3,8,2],[4,3,2],[4,4,1],[4,5,1],[5,4,2],[5,5,1],[5,6,1],[6,5,2],[6,6,1],[7,6,2],[8,7,2],[7,8,1],[6,9,1],[5,10,0],[8,8,1],[9,9,2],[10,10,2],[8,11,1],[9,12,0],[12,4,1],[13,4,2],[14,4,1],[12,5,0],[13,5,1],[14,5,0],[12,8,1],[14,8,2],[12,12,1],[13,12,2],[14,12,1]],
  'dvd-bounce': [[3,5,2],[4,4,2],[5,4,2],[6,4,2],[7,4,2],[8,4,2],[9,4,2],[10,4,2],[11,4,2],[12,5,2],[3,6,1],[4,6,2],[5,6,1],[7,6,2],[8,6,2],[9,6,1],[11,6,2],[12,6,1],[3,7,1],[5,7,1],[7,7,2],[9,7,2],[11,7,2],[12,7,1],[3,8,2],[4,8,2],[5,8,2],[7,8,2],[8,8,2],[11,8,2],[12,8,1],[4,10,0],[5,10,1],[6,11,1],[7,11,2],[8,11,2],[9,11,1],[10,10,1],[11,10,0]],
};
