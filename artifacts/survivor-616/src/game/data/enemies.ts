...
export const ENEMIES: EnemyDef[] = [
  ...
  // The Mirror Lounge -- a room that never turns the lights back up.
  {
    id: 'disco-diva',
    name: 'Disco Diva',
    family: 'Disco',
    ...
    xp: 9,
    mass: 1.2,
    ranged: { cooldownMs: 900, projectileSpeed: 260, damage: 12 },
    palette: palette({ ink: '#1a0a1f', body: '#c026d3', bodyDark: '#701a75', accent: '#67e8f9', accentBright: '#ecfeff' }),
    rig: humanoidRig({ height: 20, width: 10, headColor: 'accent', torsoColor: 'body' }),
    faction: 'Mirror Ball Cartel',
    role: 'sniper',
    lore: 'She never left the floor. The lasers are just how she claps now.',
  },
  {
    id: 'mirrorball-heavy',
    name: 'Mirrorball Heavy',
    family: 'Disco',
    behavior: 'drifter',
    hp: 150,
    speed: 22,
    ...
    mass: 6,
    sizeClass: 'giant',
    traits: { shiftMs: 3000, shiftScale: 1.15 },
    palette: palette({ ink: '#0a0a0a', body: '#e5e7eb', bodyDark: '#9ca3af', accent: '#facc15', accentBright: '#ffffff' }),
    rig: blobRig({ height: 34, width: 30, spikes: true }),
    faction: 'Mirror Ball Cartel',
    role: 'anchor',
    lore: 'It fell from the ceiling once. It has been rolling toward the beat ever since.',
  },
  {
    id: 'chroma-wisp',
    name: 'Chroma Wisp',
    ...
    mass: 0.6,
    sizeClass: 'mini',
    traits: { colorCycleMs: 1400, swayRadius: 60 },
    palette: palette({ ink: '#0a0a12', body: '#f472b6', bodyDark: '#831843', accent: '#a855f7', accentBright: '#ffffff' }),
    rig: blobRig({ height: 8, width: 8, tendrils: true }),
    faction: 'Mirror Ball Cartel',
    role: 'swarm',
    lore: 'Never the same color twice. Nobody has caught it long enough to check if it has a favorite.',
  },
  {
    id: 'disco-orb-prime',
    name: 'Disco Orb Prime',
    family: 'Boss',
    behavior: 'spitter',
    hp: 480,
    speed: 16,
    ...
    mass: 8,
    sizeClass: 'giant',
    ranged: { cooldownMs: 420, projectileSpeed: 300, damage: 16 },
    traits: { shiftMs: 1800, shiftScale: 1.2, colorCycleMs: 2000 },
    palette: palette({ ink: '#0a0a0a', body: '#e5e7eb', bodyDark: '#a855f7', accent: '#f472b6', accentBright: '#ffffff' }),
    rig: blobRig({ height: 44, width: 40, spikes: true, tendrils: true }),
    faction: 'Mirror Ball Cartel',
    role: 'anchor',
    lore: 'The first name the block ever gave a light fixture. It hangs where the ceiling used to be, and it never stops shining.',
  },
];
