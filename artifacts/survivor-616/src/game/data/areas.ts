...
export const AREAS: AreaDef[] = [
  ...
  {
    id: 'mirror-lounge',
    name: 'The Mirror Lounge',
    district: 'Under Old Market Hall',
    description:
      'One door past the stock room, the lights never came back up -- they just started changing color and never stopped.',
    backdrop: 'art/street.jpeg',
    bounds: { w: 760, h: 640 },
    ground: { base: '#140a1c', tile: '#20102e', seam: '#0a0512', glow: '#f472b6' },
    sky: 'roofed',
    discoFloor: true,
    obstacles: [
      { x: -280, y: -180, w: 50, h: 50, kind: 'reflective-surface' },
      { x: 280, y: 180, w: 50, h: 50, kind: 'reflective-surface' },
      { x: -260, y: 180, w: 50, h: 50, kind: 'reflective-surface' },
      { x: 260, y: -180, w: 50, h: 50, kind: 'reflective-surface' },
      { x: 0, y: -230, w: 150, h: 32, kind: 'barrier' },
      { x: 0, y: 230, w: 150, h: 32, kind: 'barrier' },
      { x: -90, y: 0, w: 44, h: 44, kind: 'neon-sign' },
      { x: 90, y: 0, w: 44, h: 44, kind: 'neon-sign' },
      { x: 0, y: 0, w: 74, h: 56, kind: 'cover' },
    ],
    durationSec: 175,
    threat: 'severe',
    discoveryId: 'mirror-lounge-floor',
    unlock: { kind: 'clearArea', areaId: 'neon-overflow' },
    waves: [
      { fromSec: 0, toSec: 60, enemyId: 'chroma-wisp', ratePerSec: 1.6, burst: 3, formation: 'ring' },
      { fromSec: 20, toSec: 175, enemyId: 'disco-diva', ratePerSec: 0.5, burst: 1 },
      // The whole Mirror Ball Cartel arrives together, once, as a set-piece.
      squadWave({ fromSec: 55, toSec: 56, factionId: 'mirror-ball-cartel', ratePerSec: 1, burst: 1, formation: 'wedge' }),
      { fromSec: 90, toSec: 175, enemyId: 'mirrorball-heavy', ratePerSec: 0.2, burst: 1, hpMult: 1.1 },
      { fromSec: 150, toSec: 151, enemyId: 'disco-orb-prime', ratePerSec: 1, burst: 1 },
    ],
  },
  {
    id: 'northline-yard',
