...
export const AREAS: AreaDef[] = [
  {
    ...
    obstacles: [
      ...
      { x: 210, y: -110, w: 40, h: 50, kind: 'vending-machine' },
      { x: -150, y: 130, w: 50, h: 50, kind: 'crate' },
      { x: 20, y: 60, w: 55, h: 55, kind: 'planter' },
    ],
    durationSec: 120,
    threat: 'low',
    rescueAllyId: 'vee',
  ...
  },
  {
    ...
    obstacles: [
      ...
      { x: 100, y: 40, w: 40, h: 50, kind: 'vending-machine' },
      { x: -90, y: -80, w: 58, h: 52, kind: 'barrel' },
    ],
    durationSec: 150,
    threat: 'rising',
    rescueAllyId: 'deacon',
  ...
  },
  {
    ...
    obstacles: [
      ...
      { x: -420, y: -60, w: 40, h: 50, kind: 'vending-machine' },
      { x: 240, y: -180, w: 60, h: 60, kind: 'crate-breakable' },
    ],
    durationSec: 165,
    threat: 'high',
    rescueAllyId: 'nyx',
  ...
  },
  {
    ...
    obstacles: [
      ...
      { x: -260, y: -60, w: 40, h: 50, kind: 'vending-machine' },
      { x: 90, y: -220, w: 58, h: 58, kind: 'crate-breakable' },
    ],
    durationSec: 150,
    threat: 'high',
    rescueAllyId: 'sable',
  ...
  },
  {
    ...
    obstacles: [
      ...
      { x: 150, y: -40, w: 40, h: 50, kind: 'vending-machine' },
      { x: -150, y: 40, w: 55, h: 55, kind: 'planter' },
    ],
    durationSec: 180,
    threat: 'severe',
    rescueAllyId: 'mamajo',
  ...
  },
  {
    ...
    obstacles: [
      ...
      { x: 0, y: 150, w: 40, h: 50, kind: 'vending-machine' },
      { x: -150, y: -60, w: 60, h: 60, kind: 'crate' },
    ],
    durationSec: 175,
    threat: 'severe',
    rescueAllyId: 'sable',
