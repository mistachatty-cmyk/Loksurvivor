...
export const ENDLESS_BANDS: EndlessBandDef[] = [
  ...
  },
  {
    ...
    enemyPool: ['ash-wisp', 'bloodhound', 'belfry-bat', 'bridge-lookout'],
  ...
  },
  {
    ...
    enemyPool: ['bloodhound', 'crypt-spitter', 'crypt-bouncer', 'lightless-prowler'],
  ...
  },
  {
    ...
    enemyPool: ['lightless-prowler', 'river-wraith', 'bass-bruiser', 'crypt-bouncer'],
