...
export const FIRST_NIGHT_CHAPTERS: FirstNightChapter[] = [
  ...
  },
  {
    ...
    beatText: 'A pink beacon flashes from the next roof. The city has a second map, written above the streets.',
  ...
  },
  {
    ...
    goal: 'Trace the warm trail below Fulton and learn what the city is growing underground.',
    worldVerb: 'EXPLORE',
    beatAtSec: 42,
  ...
  },
  {
    ...
    sireSignal: 'First confirmed Sire transmission',
  },
  {
    areaId: 'riverfront',
    chapter: 6,
  ...
  },
  {
    ...
    goal: 'Trace the route pattern through the rail yard and find where the city’s supplies disappear.',
    worldVerb: 'FOLLOW',
    beatAtSec: 58,
    beatTitle: 'The switch is still warm',
    beatText: 'A freight beacon blinks toward the courthouse. Whatever is moving through 616 is headed for Civic Plaza.',
