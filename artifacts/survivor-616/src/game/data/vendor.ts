...
export const VENDOR_CATALOG: VendorItemDef[] = [
  ...
  {
    id: 'threat-matrix-console',
    name: 'Threat Matrix Quarantine Terminal',
    description: 'Direct security override console. Spend loot keys to unlock the Threat Matrix screen to activate, quarantine, or disable any enemy across all maps.',
    category: 'ability',
    cost: 4,
    maxStacks: 1,
    currency: 'skeletonKeys',
    effects: [{ kind: 'utility', utility: 'threat-matrix', amount: 1 }],
  },
  {
    id: 'universal-incursion',
    name: 'Universal Incursion Engine',
    description: 'Dimensional boundary collapse upgrade. Unleashes cross-faction incursion rifts, allowing every enemy in the bestiary to invade all maps.',
    category: 'relic',
    cost: 6,
    maxStacks: 1,
    currency: 'skeletonKeys',
    effects: [{ kind: 'utility', utility: 'universal-incursion', amount: 1 }],
  },
  {
    id: 'corner-magnet',
    name: 'Corner Magnetism Field',
    description: 'Screensaver trajectory recalibrator. Triples the corner hit tolerance on the DVD Bouncing Logo for massive screen-clearing detonations.',
    category: 'relic',
    cost: 5,
    maxStacks: 1,
    currency: 'skeletonKeys',
    effects: [{ kind: 'utility', utility: 'corner-magnet', amount: 1 }],
  },
  {
    id: 'tidal-anchor',
    name: 'Tidal Hydro-Anchor',
    description: 'Heavy hydraulic magnet boots that counteract fluid dynamics, dampening Bubble Wash suds surges and lateral flow currents by 75%.',
    category: 'relic',
    cost: 4,
    maxStacks: 1,
    currency: 'skeletonKeys',
    effects: [{ kind: 'utility', utility: 'tidal-anchor', amount: 1 }],
  },
  {
    id: 'static-inverter',
    name: 'Static Friction Inverter',
    description: 'Inverts static friction from Dust Mite electrical chains into personal kinetic propulsion and kinetic shields.',
    category: 'relic',
    cost: 5,
    maxStacks: 1,
    currency: 'skeletonKeys',
    effects: [{ kind: 'utility', utility: 'static-inverter', amount: 1 }],
  },
  ...
  {
    id: 'contract-tree-null',
    name: 'Contract: Tree Null Incursion',
    description: 'Unlocks bio-digital Arbor Collective tree enemies in all sectors with higher threat and +45% contract reward payout.',
    category: 'challenge',
    cost: 260,
    maxStacks: 1,
    challengeId: 'tree-null',
  },
  {
    id: 'bounty-arbor-collective',
    name: 'Arbor Collective Bounty',
    description: 'Quartermaster bounty: Root Sentries, Holo-Bramble Mimics, and Spore Arbors payout +15% bonus creds on run completion.',
    category: 'utility',
    cost: 220,
    maxStacks: 2,
  ...
  {
    id: 'arbor-defoliator',
    name: 'Bio-Digital Defoliator',
    description: '+8% global weapon power and reinforced resistance to slice through digital brambles and piercing thorn fissures.',
    category: 'ability',
    cost: 300,
    maxStacks: 2,
    effects: [{ kind: 'stat', stat: 'power', add: 0.08, cap: 2.0 }],
  },
  {
    id: 'relic-digital-sap',
    name: 'Crystallized Digital Sap',
    description: 'A fossilized amber data core mined from Yggdrasil Null. Extends pickup magnet range by +35 and adds +25 max HP.',
    category: 'relic',
    currency: 'skeletonKeys',
    cost: 2,
    maxStacks: 2,
    effects: [
      { kind: 'stat', stat: 'magnet', add: 35, cap: 280 },
      { kind: 'stat', stat: 'maxHp', add: 25, cap: 350 },
    ],
  },
  {
    id: 'vendor-binary-branch',
    name: 'Binary Branch Requisition',
    description: 'Quartermaster field permit: Begin every run with +1 starting signature weapon level to fast-track botanical evolutions.',
    category: 'utility',
    cost: 280,
    maxStacks: 2,
    effects: [{ kind: 'utility', utility: 'starting-weapon-level', amount: 1 }],
  ...
  {
    id: 'vendor-singularity-core',
    name: 'Singularity Core Permit',
    description: 'Otis authorizes unstable gravitational munitions in your field kit. +1 starting weapon level.',
    category: 'utility',
    cost: 340,
    maxStacks: 1,
    effects: [{ kind: 'utility', utility: 'starting-weapon-level', amount: 1 }],
