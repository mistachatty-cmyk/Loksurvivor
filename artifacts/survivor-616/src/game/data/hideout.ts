...
export const HIDEOUT_SCENES: Record<string, HideoutSceneDef> = {
  ...
  'rooftop-perch': {
    ...
    homeDescription: 'A patched lookout nest with marker lamps, spare blankets, and a view of the grid.',
    homeAccent: '#38bdf8',
    skyAccent: '#164e63',
    motionKind: 'drones',
    flavorLines: [
      'The fog swallows the sirens before they can find the roof.',
      'A marker lamp blinks twice: someone out there made it home.',
  ...
  'the-storefront': {
    ...
    homeName: 'The Neon Sleeve',
    homeDescription: 'A blue-lit counter of sealed packs, card binders, and tiny companions waiting for their next run.',
    homeAccent: '#f0abfc',
    skyAccent: '#1e1b3a',
    motionKind: 'drones',
    flavorLines: [
      'The foil wrappers catch the streetlight every time the door opens.',
      'A LokPet paws at an unopened sleeve from behind the counter.',
      'The binder rings close with a soft magnetic click.',
    ],
  },
};
