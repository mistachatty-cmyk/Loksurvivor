...
export const HUB_ROOMS: HubRoomDef[] = [
  {
    ...
    biome: 'sanctum',
    unlock: { kind: 'default' },
    features: ['runs', 'roster', 'vendor', 'workshop', 'allies', 'music', 'settings', 'palette-store', 'lookbook'],
  },
  {
    id: 'rooftop-perch',
    name: 'The Perch',
    ...
    features: ['runs', 'recovery', 'bestiary', 'unlocks', 'settings', 'palette-store', 'lookbook'],
  },
  {
    id: 'the-cellar',
    name: 'The Cellar',
    ...
    features: ['music', 'bestiary', 'allies', 'unlocks', 'settings', 'palette-store', 'lookbook'],
  },
  {
    id: 'the-alley',
    ...
    features: ['vendor', 'workshop', 'allies', 'settings', 'palette-store', 'lookbook'],
  },
  {
    id: 'the-storefront',
    name: 'The Storefront',
    ...
    features: ['bestiary', 'unlocks', 'allies', 'settings', 'palette-store', 'lookbook'],
  },
];
