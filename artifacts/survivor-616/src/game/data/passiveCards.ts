...
export const PASSIVE_CARDS: PassiveCardDef[] = [
  ...
  scenario('signal-vacuum', 'Street Vacuum', 'epic', 'Pickup reach grows 12%.', { magnetMult: 1.12 }, ['pickup']),
  ...
  pet('unknown-clock-signal', 'Unknown Clock Pulse', 'legendary', 'Clockwork LokPet hits release a slowing pulse.', { clockworkSlow: true }, ['clockwork']),
