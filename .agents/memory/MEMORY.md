...
- [Out-of-map world](out-of-map-world.md) — dash phasing opens walls but never the arena bounds; gas tanks chain in one bounded pass; `radialShots` is a firing shape, not a behavior; the Instant Transmission charge is force-only.
