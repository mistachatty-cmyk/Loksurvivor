...
- [Time abilities and the pause read model](time-abilities-and-pause.md) — run speed is one composed clamp, time abilities ride the ultimate's cooldown, timeless locks composition not difficulty, and the pause menu reads existing timers instead of keeping its own.
